...
int main()
/* El programa recive un numero positivo y entero
 ...
 */
{
    int range, sum=1, criterion=0, num=1;/*
         ...
         -La variable p son los números que cumplen el criterio de aumento y deben agregarse
        */
    ...
    while (num<(range*range)) // Mientras los numero que cumplan el criterio de aumento sean menores al numero maximo
    {
        ...
        {
            num = num+criterion; // Cada numero debe tener una diferencia del criterio de incrmento.
            sum = sum+num; // Acumulamos el numero en la ariable sum
        }
    }
